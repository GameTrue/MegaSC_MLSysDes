...
- КОЛИЧЕСТВО шагов должно точно соответствовать числу узлов на диаграмме. Типичная диаграмма содержит 5–30 узлов. НИКОГДА не генерируй больше шагов, чем видишь на изображении. Если шаг повторяется — НЕ ДУБЛИРУЙ его.
